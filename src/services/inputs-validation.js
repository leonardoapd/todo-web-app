export function validateInput(name, value) {
    ...
    const errorMessages = {
        ...
        password: validation.password && length < 8 ? "" : "The password must be at least 8 characters long and contain at least one uppercase letter, one lowercase letter, and one number",
