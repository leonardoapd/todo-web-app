...
import { completeTodo, editTodo, deleteTodo } from '../../services/todo-service';
	...
	return (
		<>
			<li className='app__todo-item'>
				...
				<label
					id={item.id}
					className={item.isCompleted ? 'app__todo-label done' : 'app__todo-label'}
				...
				{contentEditable ? (
					<div className='app__buttons'>
						<button className='app__button save-button' onClick={handleSave} type='button'>
							{isMobile ? <i className='material-symbols-outlined'>save</i> : 'Save'}
						</button>
						<button className='app__button delete-button' onClick={handleDelete} type='button'>
							{isMobile ? <i className='material-symbols-outlined'>delete</i> : 'Delete'}
						</button>
						<button
							...
							type='button'
						>
							{isMobile ? <i className='material-symbols-outlined'>close</i> : 'Close'}
						</button>
					</div>
				) : (
					<button className='app__button' onClick={() => setContentEditable(true)} type='button'>
						Edit
					</button>
				)}
			</li>
